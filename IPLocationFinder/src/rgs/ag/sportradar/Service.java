 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://sportradar.ag.rgs/", wsdlLocation = "file:/D:/Project/Temp/SoapService.wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://sportradar.ag.rgs/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Project/Temp/SoapService.wsdl");
    ...
    public IService getBasicHttpsBindingIService() {
        return super.getPort(new QName("http://sportradar.ag.rgs/", "BasicHttpsBinding_IService"), IService.class);
    }
    ...
    public IService getBasicHttpsBindingIService(WebServiceFeature... features) {
        return super.getPort(new QName("http://sportradar.ag.rgs/", "BasicHttpsBinding_IService"), IService.class, features);
    }
